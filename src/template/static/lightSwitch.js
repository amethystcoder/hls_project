...
function setToLightMode() {
    ...
    let glassys = document.querySelector(".glassy-dark")
    glassys.classList.add("glassy")
    glassys.classList.remove("glassy-dark")
 ...
 */    
    let glassys = document.querySelector(".glassy")
    glassys.classList.add("glassy-dark")
    glassys.classList.remove("glassy")
    let inputs = document.querySelectorAll("input,textarea")
    for (let index = 0; index < inputs.length; index++) {
        inputs[index].style.backgroundColor = "transparent"
